        ...
        <div className="flex flex-col sm:flex sm:flex-row gap-3 py-10 hover:cursor-pointer">
          ...
          <div className="py-2 px-2 flex sm:flex-col lg:flex-row w-[100%] sm:gap-2 gap-3 lg:justify-start sm:justify-center items-center shadow-md shadow-gray-500 rounded-sm hover:translate-y-[-12px] duration-300">
            ...
            <div className="lg:ml-[6px] flex flex-col lg:justify-start sm:justify-center sm:items-center lg:items-start">
              <h1 className="sm:text-[22px] text-[20px] font-bold">Y.Ghana Sathya Karthik</h1>
              ...
              <div className="flex justify-start items-center sm:gap-2 gap-1 mt-1">
                <a href="https://www.instagram.com/y._g.s.karthik_chowdary?igsh=MXE2MGpqM3F4cHc2Yg==" target='_blank' rel="noopener noreferrer"><FaInstagram className="text-[18px] sm:text-[20px]  hover:text-[#fe8150] hover:cursor-pointer" /></a>
                <a href="https://x.com/karthik91115484?t=adoxw35PGC-51kdlcPBg1A&s=09" target='_blank' rel="noopener noreferrer"><FaTwitter className="text-[18px] sm:text-[20px]  hover:text-blue-600 hover:cursor-pointer" /></a>
                <a href="https://www.linkedin.com/in/yendluri-ghana-sathya-karthik-8689802b7?utm_source=share_via&utm_content=profile&utm_medium=member_android" target='_blank' rel="noopener noreferrer"><FaLinkedin className="text-[18px] sm:text-[20px]  hover:text-blue-600 hover:cursor-pointer" /></a>
                <a href="https://github.com/yghanasathyakarthik" target='_blank' rel="noopener noreferrer"><FaGithub className="text-[18px] sm:text-[20px]  hover:text-slate-600 hover:cursor-pointer" /></a>
              </div>
            </div>
          </div>
          <div className="py-2 px-2 flex sm:flex-col lg:flex-row w-[100%] sm:gap-2 gap-3 lg:justify-start sm:items-center items-center shadow-md shadow-gray-500 rounded-sm hover:translate-y-[-12px] duration-300">
            ...
            <div className="lg:ml-[6px] flex flex-col lg:justify-start sm:justify-center sm:items-center lg:items-start gap-1">
              <h1 className="sm:text-[22px] text-[20px] font-bold">V.Charu Brunda Hasini</h1>
              <h2 className="sm:text-[20px] text-[18px] font-medium text-purple-500">Secretary</h2>
              <h2 className="text-[18px] font-medium">3rd Year,IT</h2>
              <div className="flex justify-start items-center sm:gap-2 gap-1 mt-1">
                <a href="https://www.instagram.com/charu_brunda_hasini?utm_source=qr&igsh=Nmh4eTA5N3oybDRt" target='_blank' rel="noopener noreferrer"><FaInstagram className="text-[18px] sm:text-[20px]  hover:text-[#fe8150] hover:cursor-pointer" /></a>
                <a href="https://x.com/charu37904?t=RSRvV4iH1C344oK6SImlpg&s=09" target='_blank' rel="noopener noreferrer"><FaTwitter className="text-[18px] sm:text-[20px]  hover:text-blue-600 hover:cursor-pointer" /></a>
                <a href="https://www.linkedin.com/in/charu-brunda-hasini-vallabhuni-8749232b7?utm_source=share_via&utm_content=profile&utm_medium=member_android" target='_blank' rel="noopener noreferrer"><FaLinkedin className="text-[18px] sm:text-[20px]  hover:text-blue-600 hover:cursor-pointer" /></a>
                <a href="https://github.com/charuhasini1710-bit" target='_blank' rel="noopener noreferrer"><FaGithub className="text-[18px] sm:text-[20px]  hover:text-slate-600 hover:cursor-pointer" /></a>
              </div>
            </div>
          </div>
        </div>
