...
const Sidebar = () => {
  ...
  return (
    ...
    <div className='z-[7] lg:hidden fixed right-0 top-[60px] sm:top-[70px] w-[100%] flex justify-end items-center gap-2 px-2 py-2 mb-5 shdow-sm shadow-slate-400  bg-white'>
